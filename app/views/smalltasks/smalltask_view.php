...
<h1 class="text-center">
    ...
    <div class="d-flex justify-content-between">
        ...
        <a class="btn-sm btn-dark" href='/igbj/registrar_subtarea?codTar=<?php echo $tarea["CODTAREA"]; ?>' id="create-btn">Crear</a>
    </div>
            ...
            <tr>
                    ...
                    <td class="acciones">
                        <div class="icons modificar d-flex justify-content-center">
                            <a href="/igbj/modificar_subtarea?subtarea=<?= $tabla['CODSUBTAREA'];?>&tarea=<?php echo $tarea["CODTAREA"];?>" class="fas fa-pen align-self-center"></a>
                        </div>                                              
                        <?php if ($tabla["ESTADO"] == 1): ?>
                            <div class="icons deshabilitar d-flex justify-content-center">
                                <a href="/igbj/deshabilitar_subtarea?codigo=<?= $tabla['CODSUBTAREA'];?>&codTar=<?php echo $tarea["CODTAREA"];?>" class="fas fa-lock-open align-self-center"></a>
                            </div>
                        <?php else: ?>
                            <div class="icons habilitar d-flex justify-content-center">
                                <a href="/igbj/habilitar_subtarea?codigo=<?= $tabla['CODSUBTAREA'];?>&codTar=<?php echo $tarea["CODTAREA"];?>" class="fas fa-lock align-self-center"></a>
                            </div>
                        <?php endif; ?>
                    </td>
                </tr>
