$(document).ready(function () {
    ...
    let $departamento = document.querySelector('#clase')
    let $provincia = document.querySelector('#marca')
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                departamentos.forEach(departamento => {
                    template += `<option class="form-control" value="${departamento.codProvincia}">${departamento.nomProvincia}</option>`;
                })
    ...
    function cargarProvinciass(alumnos)
    {
	    $.ajax({
		    url : 'select.php',
		    type : 'POST',
