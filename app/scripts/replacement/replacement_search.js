        ...
        success: function (response) {
          ...
          repuesto.forEach((repuesto) => {
            ...
            templete += `<td>${repuesto.CANTIDAD}</td>`;
                ...
                templete += `<a href="/igbj/actualizar_repuesto?repuesto=${repuesto.CODREPUESTO}" class="fas fa-pen align-self-center"></a>`;
                templete += `</div>`;

                if(repuesto.ESTADO == 1){
                  templete += `<div class="icons deshabilitar d-flex justify-content-center">`;
                  templete += `<a href="/igbj/deshabilitar_repuesto?codigo=${repuesto.CODREPUESTO}" class="fas fa-lock-open align-self-center"></a>`;
                  templete += `</div>`;
                }else{
                  templete += `<div class="icons habilitar d-flex justify-content-center">`;
                  templete += `<a href="/igbj/habilitar_repuesto?codigo=${repuesto.CODREPUESTO}" class="fas fa-lock align-self-center"></a>`;
                  templete += `</div>`;
                }
